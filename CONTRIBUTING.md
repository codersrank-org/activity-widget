...
- Create an [issue](https://github.com/codersrank-org/activity/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/codersrank-org/activity/issues), assuming one does not already exist.
