...
- Create an [issue](https://github.com/codersrank-org/widget-activity/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/codersrank-org/widget-activity/issues), assuming one does not already exist.
